package za.co.iteampay.pay.qr.results;
...
import za.co.iteampay.pay.qr.DetailResultActivity;
import za.co.iteampay.pay.qr.ExceptionDetails;
import com.mastercard.labs.sng.qrscantester.R;
import za.co.iteampay.pay.qr.api.response.PaymentResponse;
import za.co.iteampay.pay.qr.model.PaymentData;
import za.co.iteampay.pay.qr.results.tag.SubDataModelTag;
import za.co.iteampay.pay.qr.results.tag.Tag;
...
import static za.co.iteampay.pay.qr.DetailFragment.IS_GENERATE;
import static za.co.iteampay.pay.qr.DetailFragment.TAG_INSTANCE;
